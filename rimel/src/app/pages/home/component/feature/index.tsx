...
export default function Featured() {
 return (
   <main className="px-10 py-12 top-auto relative bottom-60">
           ...
           <div>
             <div className="relative rounded-lg overflow-hidden  bg-black w-[670px] ">
               ...
               <div className="absolute left-7 top-33 text-white">
                 ...
                 <Link href="/shop/woman" className="inline-block  text-white px-4 py-1 rounded-full font-bold text-lg transition underline ml-2">
                   Shop Now
                 </Link>
               </div>
             </div>
